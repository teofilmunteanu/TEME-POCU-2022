package com.project.Tema7_springWeb.aspect;
...
public class ControllerAspect {
    ...
    @Pointcut("within(com.project.Tema7_springWeb.controller.UserController)")
    private void userControllerMethod(){

    }


    @Pointcut("within(com.project.Tema7_springWeb.controller.CarInsuranceControllerDev)")
    private void carControllerMethod(){

    }


    @Pointcut("execution(* com.project.Tema7_springWeb.controller.HouseInsuranceController.getHouseInsurancePrice(..))")
